			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30 j_wrapper">
						<div class="col-sm-8">
						<h4>K&N Premium Wrench-Off® Marine Oil Filters</h4>
						<br>
						<h5><strong>What makes K&N oil filters better?</strong></h5>
						<h6>
							The K&N Premium Wrench-Off® Oil Filter has been constructed from the ground up to satisfy the high performance needs of marine applications, as well as the average boat who wants the very best oil filter available. Our oil filter has a high efficiency rating for outstanding filtration. A 1 inch nut on the end of the filter provides for easy removal. This nut is drilled through to allow the use of a safety wire; great for off shore or rough water.
						</h6>
						<br>
						<h6>
							We use metal top end caps instead of paper to ensure that no unfiltered oil can get back into the system. They are covered by a limited warranty to be free from defects in materials and workmanship when installed and replaced using engine and equipment manufacturers recommended service interval.
						</h6>
						</div>
						<div class="col-sm-4">
							<img src="image/OIL-FILTER-flip-new3-250w.jpg" class="j_border">
						</div>

						<div class="col-sm-8 j_wrapper">
							<h4><strong>K&N Marine Oil Filters for Inboard Motors</strong></h4><br>
						  <h5>
						...
						<div class="col-sm-8 j_wrapper">
							<h4><strong>K&N Marine Oil Filters for Outboard Motors</strong></h4><br>
						  <h5>
							<table class="table-responsive">
								  <thead>
								    <tr>
						...
						<div class="col-sm-8 j_wrapper">
							<h4><strong>K&N Premium Marine Oil Filters by Engine Type</strong></h4><br>
						  <h5>
							<table class="table-responsive">
								  <thead>
								    <tr>
								  ...
								  <tbody>
								    <tr>
								      <td>Small/ Big Block Ford</td>
								      <td>HP-3001</td>
								    </tr>
								    <tr>
								      <td>Small/ Big Block GM (Long)</td>
								      <td>HP-3002</td>
								    </tr>
								    <tr>
								      <td>Small/ Big Block GM(Short)</td>
								      <td>HP-2002</td>
								    </tr>

								    <tr>
								      <td>Big Block GM 2 QT Capacity</td>
								      <td>HP-6002</td>
								    </tr>

								    <tr>
								      <td>Small/ Block CHrysler</td>
								      <td>HP-2004</td>
								    </tr>

								    <tr>
								      <td>Racing/ Remote Filter Equal to Fram HP-6</td>
								      <td>HP-5001</td>
								    </tr>
								  </tbody>
							</table>
						...
						<div class="col-sm-8 j_wrapper">
							<h4><strong>K&N Premium Marine Oil Filters by Vehicle Manufacturer</strong></h4>
							<h5><strong>K&N Oil Filters for Honda Aquatrax</strong></h5><br>
						  <h5>
							<table class="table-responsive">
								  <thead>
								    <tr>
								  ...
								  <tbody>
								    ...
								    <tr>
								      <td>1200</td>
								      <td>ARX1200T2 Aquatrax R-12X</td>
								      <td>03-07</td>
								      <td>KN-204</td>
								      <td></td>
								    </tr>
								    ...
								    <tr>
								      <td>1200</td>
								      <td>ARX1200T3 Aquatrax F-12X</td>
								      <td>02-07</td>
								      <td>KN-204*C</td>
								      <td>Chrome</td>
								    </tr>
								    ...
								    <tr>
								      <td>1200</td>
								      <td>ARX1200T3D Aquatrax F-12X GPScape</td>
								      <td>05-07</td>
								      <td>KN-204</td>
								      <td>KN-204</td>
								      <td></td>
						...
						<div class="col-sm-8 j_wrapper">
							<h4><strong>K&N Oil Filters for Kawasaki Jet Ski</strong></h4><br>
						  <h5>
							<table class="table-responsive">
								  <thead>
								    <tr>
								  ...
								  <tbody>
								    <tr>
								      <td>1200</td>
								      <td>JT1200 STX-12F</td>
								      <td>03-06</td>
								      <td>KN-204</td>
								    </tr>
								    <tr>
								      <td>1500</td>
								      <td>JT1500 STX-15F</td>
								      <td>04-08</td>
								      <td>KN-204</td>
								    </tr>
								  </tbody>
						...
						<div class="col-sm-8 j_wrapper">
							<h4><strong>K&N Oil Filters for Sea Doo</strong></h4><br>
						  <h5>
							<table class="table-responsive">
								  <thead>
								    <tr>
								  ...
								  <tbody>
								    ...
								    <tr>
								      <td>1494</td>
								      <td>GTX 4-Tec ltd. Supercharged</td>
								      <td>03-04</td>
								      <td>KN-556</td>
								    </tr>
								    ...
								    <tr>
								      <td>1494</td>
								      <td>GTX 4-Tec Wakeboard Edition</td>
								      <td>04</td>
								      <td>KN-556</td>
								    </tr>
						...
						<div class="col-sm-8 j_wrapper">
							<h4><strong>K&N Oil Filters for Yamaha WaveRunner</strong></h4><br>
						  <h5>
							<table class="table-responsive">
								  <thead>
								    <tr>
								  ...
								  <tbody>
								    <tr>
								      <td>1000</td>
								      <td>FX1000 WaveRunner</td>
								      <td>05-07</td>
								      <td>KN-303</td>
								    </tr>
								    <tr>
								      <td>1000</td>
								      <td>FX1000 WaveRunner - Chrome</td>
								      <td>05-07</td>
								      <td>KN-303C</td>
								    </tr>
								    <tr>
								      <td>1000</td>
								      <td>FX1000 WaveRunner Cruiser</td>
								      <td>05-07</td>
								      <td>KN-303</td>
								    </tr>
								    <tr>
								      <td>1000</td>
								      <td>FX1000 WaveRunner Cruiser H.O. - Chrome</td>
								      <td>05-07</td>
								      <td>KN-303C</td>
								    </tr>
								    <tr>
								      <td>1000</td>
								      <td>FX1000 WaveRunner H.O.</td>
								      <td>04-06</td>
								      <td>KN-303</td>
								    </tr>
								    <tr>
								      <td>1000</td>
								      <td>FX1000 WaveRunner H.O. - Chrome</td>
								      <td>04-06</td>
								      <td>KN-303C</td>
								    </tr>
								    <tr>
								      <td>1000</td>
								      <td>FX1000 Wave Raider</td>
								      <td>05-06</td>
								      <td>KN-303</td>
								    </tr>
								    <tr>
								      <td>1000</td>
								      <td>FX1000 WaveRunner Delux</td>
								      <td>05-07</td>
								      <td>KN-303</td>
								    </tr>
								    <tr>
								      <td>1000</td>
								      <td>FX1000 WaveRunner Delux - Chrome</td>
								      <td>05-07</td>
								      <td>KN-303C</td>
								    </tr>
								    <tr>
								      <td>1000</td>
								      <td>FX1000 WaveRunner Sport</td>
								      <td>05-07</td>
								      <td>KN-303</td>
								    </tr>
								    <tr>
								      <td>1000</td>
								      <td>FX1000 WaveRunner Sport - Chrome</td>
								      <td>05-07</td>
								      <td>KN-303C</td>
								    </tr>
