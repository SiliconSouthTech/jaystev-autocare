...
<html lang="en"><!--<![endif]-->
	...
	<body>
		...
		<div class="wide_layout relative w_xs_auto">
									...
									<div class="clearfix t_sm_align_l f_left f_sm_none relative s_form_wrap m_sm_bottom_15 p_xs_hr_0 m_xs_bottom_5">
										...
										<nav role="navigation" class="f_left f_xs_none d_xs_none m_right_35 m_md_right_30 m_sm_right_0">	
											<ul class="horizontal_list main_menu type_2 clearfix">
												...
												<li class="relative f_xs_none m_xs_bottom_5 m_left_10 m_xs_left_0"><a href="index_layout_wide.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>About us</b></a>
													<!--sub menu-->
													<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
														<ul class="sub_menu">
															<li><a class="color_dark tr_delay_hover" href="index_layout_wide.html">Jaystev</a></li>
													<li><a class="color_dark tr_delay_hover" href="index.html">Staff</a></li>
													<li><a class="color_dark tr_delay_hover" href="index_layout_2.html">Partners</a></li>
														</ul>
													</div>
												</li>
												...
												<li class="relative f_xs_none m_xs_bottom_5 m_left_10 m_xs_left_0"><a href="category_grid.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Services</b></a>
													<!--sub menu-->
													<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
														<ul class="sub_menu">
												...
												<li class="relative f_xs_none m_xs_bottom_5 m_left_10 m_xs_left_0"><a href="category_grid.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Contact us</b></a>
													<!--sub menu-->
												</li>
											</ul>
										</nav>
			...
			<section class="about_wrapper manual-center">
									...
									<div id="tab-2">
										<form>
											<ul>
												...
												<br>
												<li><button class="button_type_4 r_corners bg_scheme_color color_light tr_all_hover">Sign Up</button></li>
											</ul>
										</form>
									</div>
								</section>
