			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
					  <div class="j_wrapper">	
						<div class="col-sm-6">
						<h4><strong>K&N Performance Parts for Cars, Trucks, Motorcycles, ATV, Watercraft and More</strong></h4>
						<h6>
							K&N offers a variety of performance parts for cars, trucks, SUV, motorcycle, marine and watercraft vehicles. Universal air filters, air/fuel monitors, in-line fuel pumps, flame arrestors and carb adapters are only a few of the high performance parts available. K&N makes it easy to find the right automotive performance parts and aftermarket car parts for your vehicle. For information about how to increase horsepower with K&N performance parts read Easy Ways to Increase Horsepower with K&N Performance Parts. 
						</h6>
						</div>
						<div class="col-sm-6">
							<img src="image/perf_parts.jpg">
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/diesel_air_intake.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Automotive Performance Parts</strong></h4></a>
								<h6>
						...
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/harley.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>ATV and Motorcycle Performance Parts</strong></h4></a>
								<h6>
									K&N ATV and motorcycle performance parts include universal air filters, filter wraps, vent filters, air/fuel ratio monitors, air filter accessories and a velocity stack filter adapter.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/diesel-inline-fuel-filters.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Diesel Fuel Filters</strong></h4></a>
								<h6>
									K&N inline diesel fuel filters include both canister and cartridge style filters which provide high flow rates and great filtration levels for diesel vehicles.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							...
							<div class="col-sm-9">
								<a href="#"><h4><strong>Inline Fuel Filters</strong></h4></a>
								<h6>
									K&N high-performance inline fuel filters come in both high-strength canister and see-through plastic versions.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/inline-fuel-pump.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Inline Fuel Pumps</strong></h4></a>
								<h6>
									K&N inline fuel pumps have a universal design and are compatible with a wide variety of fuels.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/watercraft.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Performance Parts for Boats and Personal Watercraft</strong></h4></a>
								<h6>
									K&N performance parts for boats and personal watercraft include flame arrestors, universal clamp-on air filters, and other marine accessories like carb adapters and air filter wraps.
								</h6>
							</div>	
						</div>
						</div>
