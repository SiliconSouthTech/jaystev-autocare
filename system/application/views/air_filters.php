			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
					  <div class="j_wrapper">	
						<div class="col-sm-6">
						<h4><strong>K&N Air Filters & Air Filter Cleaning Kits</strong></h4>
						<h6>
						<br>
							<ul>
								<li>High flow air filters designed to improve engine performance</li>
								<li>Designed to increase horsepower, torque, and acceleration</li>
								<li>Excellent filtration and dependable protection for long engine life</li>
								<li>Washable and reusable air filters that are easy to clean and reuse</li>
								<li>Long service intervals up to 50,000 miles depending on driving conditions</li>
								<li>Environmentally friendly reusable air filters</li>
							</ul>
						</h6>
						</div>
						<div class="col-sm-6">
							<img src="image/af_ck_hl_main2.jpg">
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/af_ck_cat1.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Automotive Stock Replacement Air Filters</strong></h4></a>
								<h6>
						...
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/af_ck_cat2.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Motorcycle and ATV Stock Replacement Air Filters</strong></h4></a>
								<h6>
									K&N motorcycle and ATV stock replacement air filters are made with an oiled cotton media for high air flow and outstanding engine protection. They have a long service life and when dirty are easy to clean.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/af_ck_cat3.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Universal Clamp-on Air Filters</strong></h4></a>
								<h6>
									K&N's Universal Clamp-on Air Filters are designed and manufactured for a wide variety of applications. They have an oiled cotton filter media that is washable and reusable. K&N manufactures hundreds of universal clamp-on air filters which are available in round, cone (tapered) and oval designs.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/VF2000_Install.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Washable Cabin Air Filters</strong></h4></a>
								<h6>
						...
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/af_ck_cat4.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Industrial / Small Engine Air Filters</strong></h4></a>
								<h6>
									K&N manufactures many direct replacement air filter elements for small industrial engines, utility lawn and garden units, air compressors, generators, chain saws, and more. Most of them are made with a synthetic air filter media and can be cleaned with K&N synthetic air filter cleaner and reused again and again.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/af_ck_cat5.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong> Heavy Duty Diesel Air Filters </strong></h4></a>
								<h6>
									K&N's line of washable commercial grade air filters are made from a durable synthetic air filter media. They are designed specifically for large turbo diesel engines, class 6-8 over-the-road trucks, agricultural and earth moving equipment, and diesel motorhomes.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/af_ck_cat10.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong> Air Filter Cleaning Kits and Accessories </strong></h4></a>
								<h6>
									K&N has air filter cleaning supplies for K&N cotton, synthetic and heavy duty synthetic air filters. K&N stock replacement air filters have cotton media. They are cleaned with K&N Power Kleen Industrial Strength Degreaser and then oiled with a specialized blend of oil.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/af_ck_cat9.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong> Racing and Custom Air Filters </strong></h4></a>
								<h6>
									K&N makes many types of air filters and assemblies for racing, off-road vehicles, carbureted engines, and more. These include filters, filter assemblies, filter lids, hood scoops, air boxes, and other products.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/af_ck_cat7.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong> Marine Air Filters/Flame Arrestors </strong></h4></a>
								<h6>
									K&N Marine Flame Arrestors are marine approved per the SAE J1928 standard. They are washable and reusable and are designed to improve horsepower and torque.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/af_ck_cat6.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong> Crankcase Vent Air Filters | Breather Filters </strong></h4></a>
								<h6>
									K&N crankcase vent filters and breather filters were designed for racing needs and to look great in show cars. They come in several styles with rubber or chrome tops, with or without shields and in a variety of mounting types for just about any valve cover need.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/facts2.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong> Air Filter Facts </strong></h4></a>
								<h6>
									There's a lot of science behind air filter design. Read how K&N low restriction air filters provide superior filtration of harmful contaminants and why that's important to your engine.
								</h6>
							</div>
						</div>
						...
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/air-filterMM.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong> Air Filters by Vehicle Manufacturer </strong></h4></a>
								<h6>
									K&N makes replacement air filters for virtually every vehicle and engine. You can add superior filtration and performance to your car, truck, motorcycle, ATV or even water craft. Select the manufacturer of your vehicle here and browse to the K&N air filter that fits your vehicle.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/cabin-air-filter-icon.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong> Cabin Air Filters by Vehicle Manufacturer </strong></h4></a>
								<h6>
									K&N creates Cabin Air Filters for a range of vehicles. These cabin air filters are designed to be a simple and quick replacement for your vehicle's stock cabin air filter. Cabin air filters are a recent addition to automotive AC/heating systems and many vehicle owners do not know they exist. K&N Cabin Air Filters are washable and reusable and will last the life of your vehicle.
								</h6>
							</div>
						</div>
						</div>
