			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30 j_wrapper">
						<div class="col-sm-6">
						<h4>K&N Oil Filter - Automotive Oil Filters</h4>
						<ul>
						...
						<br>
						<h4>Oil Filters for Cars, Trucks, SUV and more!</h4>
						<h6>K&N Oil Filters provide outstanding filtration levels and a high oil flow rate. They are able to handle heavy duty applications and block 99% of foreign material. They are great with synthetic and conventional oils! K&N offers Premium Wrench-Off, Pro-Series, Cartridge and Billet Oil Filters for a range of vehicle applications and service providers.
						</h6>
						</div>
						<div class="col-sm-6">
							<img src="image/oil-filter-quality.jpg" class="j_border">
						</div>
							<hr>
						
						<div class="j_wrapper">
							<div class="col-sm-2">
								<img src="image/HP-1007.jpg">
							</div>
							<div class="col-sm-10">
								<h4>K&N Wrench-Off Automotive Oil Filters</h4>
								<h6>K&N wrench-off oil filters are great for race applications. These canister oil filters are known for their durability, strength and easy wrench-off removal design. K & N Wrench-off motorcycle oil filter canisters have a 17mm nut and automotive oil filter canisters have a 1" nut.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-2">
								<img src="image/PS-2002.jpg">
							</div>
							<div class="col-sm-10">
								<h4>K&N Pro Series Automotive Oil Filters</h4>
								<h6>K&N Pro Series Oil Filters are specifically designed for service providers and professional installers. The Pro Series Oil Filter is known for their high capacity, low restriction design and for enhanced engine protection
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-2">
								<img src="image/KN-141.jpg">
							</div>
							<div class="col-sm-10">
								<h4>K&N Cartridge Automotive Oil Filters</h4>
								<h6>K&N high flow cartridge oil filters provide great filtration and are ideal for high end synthetic motor oils. Cartridge Oil Filters work for a range of SUV, truck and car applications.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							...
							<div class="col-sm-10">
								<h4>K&N Washable / Reusable Billet Automotive Oil Filters</h4>
								<h6>K&N Billet Oil Filters are constructed from a billet aluminum housing for strength and durability. It has a stainless steel micro-sheen and magnets for extra capacity and debris removal. It is washable and can be reused.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-2">
								<img src="image/inline-filters.jpg">
							</div>
							<div class="col-sm-10">
								<h4>K&N Inline Fuel/Oil Filters</h4>
								<h6>K&N inline fuel/oil filters are perfect for automotive racing applications. These filters can be used with a variety of oils and fuels including methanol. The filter material is made from stainless steel and the housing is made from anodized aluminum.
								</h6>
							</div>
						</div>
					</div>
