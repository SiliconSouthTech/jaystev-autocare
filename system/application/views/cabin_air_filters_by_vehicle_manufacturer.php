			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
						<br>
						<h4 class="text-center">K&N Cabin Air Filters</h4>
						<br>
						<h4><strong>Cabin Air Filters by Vehicle Manufacturer</strong></h4>
						<div class="col-sm-7">
						<h6>
							Since cabin air filters have only recently been integrated into automotive AC/heating systems, many vehicle owners don't realize their car has a cabin air filter. Most cabin air filters can be replaced without tools but some require basic hand tools to open the cabin air filter compartment.
						</h6>	
						</div>
						<div class="col-sm-5">
							<img src="image/af_ck_hl_main.jpg" class="j_image_placeholder1">
						</div>
						<div class="col-sm-12">
						<h4>
							Select a vehicle make below to find your replacement cabin air filter
						</h4>
						</div>
