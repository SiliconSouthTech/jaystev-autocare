			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
					  <div class="j_wrapper">	
						<div class="col-sm-6">
						<h4><strong>K&N Diesel Fuel Filter</strong></h4>
						<br>
						<h6>
							<ul>
								<li>Superior Construction</li>
								<li>High Fuel Flow Rates</li>
								<li>Low Restriction</li>
								<li>Large Volume</li>
								<li>Exceptional Filtration</li>
								<li>Made from strong carbon steel housing</li>
							</ul>
						</h6>
						<br>
						<h4>Diesel Fuel Filters</h4>
						<h6>
							A K&N Diesel Fuel Filter is designed to provide high flow rates and capacity, while maintaining exceptional filtration levels. They are constructed from a high strength carbon steel housing and cellulose glass medium that protects from rust, dirt and other foreign materials.
						</h6>
						</div>
						<div class="col-sm-6">
							<img src="image/PF-3000.jpg">
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-9">
							...
							<div class="col-sm-3">
								<img src="image/PF-3000s.jpg">
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Diesel Fuel Filter PF-3000</strong></h4></a>
								<h6>
									K&N PF-3000 is a canister style diesel fuel filter engineered to provide high flow rates, great filtration levels, and protection from rust and unwanted dust particles. Diesel Fuel Filter PF-3000
								</h6>
							</div>
							<div class="col-sm-3">
								<img src="image/PF-4000s.jpg">
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Diesel Fuel Filter PF-4000</strong></h4></a>
								<h6>
									K&N PF-4000 is a cartridge style diesel fuel filter engineered to provide high flow rates, great filtration levels, and protection from rust, dirt and other unwanted materials. Diesel Fuel Filter PF-4000
								</h6>
							</div>
							<div class="col-sm-3">
								<img src="image/PF-4100s.jpg">
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Diesel Fuel Filter PF-4100</strong></h4></a>
								<h6>
									K&N PF-4100 is a cartridge style diesel fuel filter engineered to provide high flow rates, great filtration levels, and protection from rust and unwanted dust particles. Diesel Fuel Filter PF-4100
								</h6>
							</div>
							<div class="col-sm-3">
								<img src="image/PF-4100s.jpg">
						...
						<hr>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Diesel Fuel Filter PF-4200</strong></h4></a>
								<h6>
									K&N PF-4200 is a cartridge style diesel fuel filter engineered to provide high flow rates, great filtration levels, and protection from rust and unwanted dust particles. Diesel Fuel Filter PF-4200
								</h6>
							</div>
							<div class="col-sm-3">
								<img src="image/PF-4200s.jpg">
							</div>
						</div>
						</div>
					  </div>
