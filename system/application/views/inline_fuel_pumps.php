			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
						<div class="j_wrapper">
							<div class="col-sm-8">
								<h4><strong>K&N Universal Inline Fuel Pumps</strong></h4>
								<br>
								<ul>
									<li>Compatible with diesel, biodiesel, gasoline, E85, methanol, ethanol, alcohol and other fuels</li>
									<li>Universal design fits most applications</li>
									<li>Self-priming design provides a quiet running volume</li>
									<li>Eliminates vapor lock and flooding</li>
									<li>Fuel filter and installation hardware is included</li>
								</ul>
							</div>
							<div class="col-sm-4">
							...
							<div class="col-sm-8">
								<h4><strong>Inline Fuel Pumps</strong></h4>
								<h6>K&N Inline Fuel Pumps provide premium quality fuel system hardware with a universal design that fits a wide variety of applications. Compatible with most fuels, this self-regulating 12-volt pump helps prevent vapor lock and flooding.
								</h6>
							</div>
							<div class="col-sm-8">
								<h4><strong>K&N Universal Inline Fuel Pump 81-0400</strong></h4>
								<h6>K&N 81-0400 universal inline fuel pump is engineered to pump 15 gallons per hour between 1 and 2 psi. Inline Fuel Pump 81-0400</h6>
							</div>
							<div class="col-sm-8">
								<h4><strong>K&N Inline Fuel Pump 81-0401</strong></h4>
								<h6>K&N 81-0401 universal inline fuel pump is engineered to pump 25 gallons per hour between 1.5 and 4 psi. Inline Fuel Pump 81-0401</h6>
							</div>
							<div class="col-sm-8">
								<h4><strong>K&N Inline Fuel Pump 81-0402</strong></h4>
								<h6>K&N 81-0402 universal inline fuel pump is engineered to pump 32 gallons per hour between 4 and 7 psi. Inline Fuel Pump 81-0402</h6>
							</div>
							<div class="col-sm-8">
								<h4><strong>K&N Inline Fuel Pump 81-0403</strong></h4>
								<h6>K&N 81-0403 universal inline fuel pump is engineered to pump 34 gallons per hour between 7 and 10 psi. Inline Fuel Pump 81-0403</h6>
							</div>
						</div>
					</div>
				</div>
