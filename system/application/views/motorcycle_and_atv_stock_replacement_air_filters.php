			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
					  <div class="j_wrapper">	
						<div class="col-sm-6">
						<h4><strong>K&N Replacement ATV and Motorcycle Air Filters</strong></h4>
						<h6>
							<ul>
								<li>Designed to provide increased Horsepower and Acceleration</li>
								<li>Pleated cotton media provides a large filtration area offering low restriction and long service intervals </li>
								<li>Multi-Layers of woven cotton gauze media offers excellent filtration</li>
								<li>Fits directly into OEM Airbox with application specific Sealing Bead ensuring a precise fit</li>
								<li>No fuel Management modifications are normally required to obtain increased performance </li>
								<li>Washable &amp; reusable, most are pre-oiled and ready to ride!</li>
							</ul>
						</h6>
						<br>
						<div class="col-sm-12">
						<h4><strong>K&N Air Filters for the Motorcycle and ATV</strong></h4>
						<br>
						<h6>
							For over 40 years K&N has been designing and manufacturing performance air filters for the motorcycle and ATV enthusiast interested in maximizing horsepower and acceleration. Our air filter is designed to achieve high, virtually unrestricted air flow while maintaining filtration levels critical to ensure long engine life. K&N Air Filters will NOT void Motorcycle Warranty and are environmentally friendly. K&N Reusable Air Filters reduce the volume of disposable air filters that end up in landfills!
						</h6>
						</div>
						</div>
						<div class="col-sm-6">
							<img src="image/harley-air-filters.jpg">
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/HD-1499-cat.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>REPLACEMENT HIGH FLOW AIR FILTERS FOR HARLEY-DAVIDSON® MOTORCYCLES</strong></h4></a>
								<h6>
									K&N's high flow replacement air filters are available as a replacement for your stock Harley-Davidson® Air Filter element. They are custom designed to fit your specific application and provide your bike with added airflow for increased performance.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/harley-screamin-eagle-filter.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>REPLACEMENT HIGH FLOW AIR FILTERS FOR SCREAMIN' EAGLE® AIR INTAKE SYSTEMS</strong></h4></a>
								<h6>
									K&N's high flow replacement air filters are available as a replacement for your Harley-Davidson® Screamin' Eagle®' air intake system filter element, as well as many types of aftermarket carburetors and intake systems. They are custom designed to fit your specific Screamin' Eagle setup and provide your bike with additional airflow for increased performance.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/sport-bike-filters.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>SPORT BIKE HIGH-FLOW AIR FILTERS FOR SPORT BIKE ENTHUSIASTS</strong></h4></a>
								<h6>
									K&N's high flow replacement air filters are designed to provide increased airflow and performance, while providing excellent engine protection for your Sport bike. K&N's washable and reusable pleated media air filter provides a large filtration area offering low restriction, better throttle response, more horsepower and long service intervals. Manufactured to fit into your stock air filter assembly with no cutting or fitting required. Fuel management modifications not normally required for increased performance.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/off-road-air-filters.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>OFF-ROAD HIGH FLOW AIR FILTERS DESIGNED SPECIFICALLY FOR YOUR MOTORCYCLE OR ATV</strong></h4></a>
								<h6>
									K&N manufactures many high flow replacement air filters specifically designed for Off-Road, Motocross, ATV's, UTV's and Side by Side Vehicles. Designed to Increase horsepower and torque, the deep pleated cotton media air filters offers a large surface area, low-restriction, high-capacity and long service intervals. The Washable and Reusable pleated media comes pre-oiled and ready for installation. K&N's Off-Road and Racing Air Filters feature a K&N One-Year Limited Warranty.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/flame-arrestors.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>PERSONAL WATERCRAFT FLAME ARRESTORS & CARBURETOR ADAPTORS</strong></h4></a>
								<h6>
									Designed to provide clean filtration from airborne impurities found in marine air. Effective both in fresh and salt water environments found near and off-shore. The heart of the K&N Flame Arrestor is the cotton gauze filter media used in our standard filter elements, sandwiched between a US Coast Guard Approved Flame Arrestor Screen. Racing only flame arrestor without cotton media also available.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/snowmobile-air-filters.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>SNOWMOBILE SPECIALTY HIGH FLOW AIR FILTERS & SNOWCHARGERS®</strong></h4></a>
								<h6>
									K&N Clamp-On Snowmobile Air Filters offer a large surface area for low restriction and excellent efficiency. Featuring ultra-strong molded pliable rubber flanges to absorb vibration and allow for secure attachment. K&N's Clamp-On Snowmobile Filters are pre-oiled and race ready.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/kart-air-filters.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>GO KART SILENCER/AIRBOX & SPECIALTY HIGH FLOW AIR FILTERS</strong></h4></a>
								<h6>
									K&N's Go kart high flow air filters are designed and manufactured for a wide variety of applications and horsepower requirements. Regardless of the mounting angle or offset diameter of the air intake, there is a K&N high flow air filter for your go kart. All K&N specialty air filters are constructed with ultra-strong molded and pliable rubber flanges, which absorb vibration and allow for secure attachment.
								</h6>
							</div>
						</div>
						</div>
