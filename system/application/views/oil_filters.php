			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
					  <div class="j_wrapper">	
						<div class="col-sm-6">
						<h4><strong>K&N Oil Filters</strong></h4>
						<h6>
							<ul>
							    <li>Outstanding Oil Filtration</li>
							    <li>High Oil Flow Rate</li>     
							    <li>Heavy Duty Construction</li>
							    <li>Great with Synthetic or Conventional Oil</li>
								<li>Traps 99% of harmful contaminants</li>
							</ul>
						</h6>
						<br>
						<h6>
							K&N oil filters are available for many cars, trucks, motorcycles, off-road vehicles, watercraft and heavy duty applications. K&N oil filters use a high flow filter media that allows for high flow rates while providing outstanding engine protection.
						</h6>
						</div>
						<div class="col-sm-6">
							<img src="image/of_cat.jpg">
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/of_cat1.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Automotive Oil Filters</strong></h4></a>
								<h6>
						...
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/of_cat2.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Motorcycle and ATV Oil Filters</strong></h4></a>
								<h6>
									K&N motorcycle and ATV oil filters use a High Flow Premium Media that allows for higher flow rates while providing outstanding filtration. Where applicable, K&N motorcycle and ATV canister oil filters come with a 17 mm nut welded to the top of the canister so they can be easily wrenched-off with a standard tool.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/of_cat3.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Marine Oil Filters</strong></h4></a>
								<h6>
									K&N offers high flow premium oil filters for many boat and personal watercraft applications. These oil filters use a High Flow Premium Media that allows for higher flow rates while providing outstanding filtration for long engine life.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/of_cat4.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Heavy Duty Oil Filters</strong></h4></a>
								<h6>
									K&N Wrench-Off Heavy Duty Diesel Oil Filters have been specially designed for the high compression levels and tighter tolerances of turbo diesel engines. These oil filters have a nut on the end for easy removal. Our synthetic microglass media provides lower restriction and incredible engine protection. K&N Heavy Duty oil filters also have a thick canister and high burst strength.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/oil-filterMM.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Oil Filters by Vehicle Manufacturer</strong></h4></a>
								<h6>
									K&N oil filters are available for many cars, trucks, motorcycles, ATV's and heavy duty applications. Select the manufacturer of your vehicle here and browse to the oil filter that fits your vehicle.
								</h6>
							</div>
						</div>
						</div>
