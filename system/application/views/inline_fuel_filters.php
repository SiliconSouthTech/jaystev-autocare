			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
					  <div class="j_wrapper">	
						<div class="col-sm-6">
						<h4><strong>K&N Inline Fuel Filter - Gas Engine Fuel Filters</strong></h4>
						<br>
						<h6>
							<ul>
								<li>Handles high fuel flow rates</li>
								<li>Low restriction filter media</li>
								<li>Available with 5/32, 1/4 and 5/16 inch flanges</li>
								<li>K&amp;N inline gas filters are available in single or 12-packs</li>
							</ul>
						</h6>
						<br>
						</div>
						<div class="col-sm-6">
							<img src="image/inline-fuel-filters.jpg">
						</div>
						<div class="col-sm-12">
						<h4>About the K&N Inline Fuel Filter</h4>
						<h6>
							K&N Inline Fuel Filters are designed to improve performance by providing excellent filtration even at high flow rates thereby reducing contaminants present in the fuel to allow it to be combusted more efficiently. K&N in-line fuel filters utilize a special low restriction filter media that is capable of handling high GPH fuel flows.
						</h6>
						</div>
						...
						<hr>
							<div class="col-sm-3">
								<img src="image/81-0291-ss.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Stainless Mesh Inline Fuel Filter</strong></h4></a>
								<h6>
								5/32" flanges 1-3/16" body diameter by 2-3/16" overall length (1-1/4" filter body length). Nylon mesh gas filter element.
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Stainless Mesh In-Line Fuel Filter - 81-0291</h6>
								<h6><strong>12-Pack:</strong></h6>
								<h6>Stainless Mesh In-Line Fuel Filters - 81-0290</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/81-0221-ss.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Stainless Mesh Inline Fuel Filter</strong></h4></a>
								<h6>
								1/4" flanges 1-5/16" body diameter by 1-3/4" overall length (3/4" filter body length). Stainless steel mesh gas filter element.
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Stainless Mesh In-Line Fuel Filter - 81-0231</h6>
								<h6><strong>12-Pack:</strong></h6>
								<h6>Stainless Mesh In-Line Fuel Filters - 81-0230</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/81-0231-ss2.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Stainless Mesh Inline Fuel Filter</strong></h4></a>
								<h6>
						...
						<hr>
							<div class="col-sm-3">
								<img src="image/81-0241-ss2.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Stainless Mesh Inline Fuel Filter</strong></h4></a>
								<h6>
								5/16" flanges 1-1/2" body diameter by 1-3/4" overall length (3/4" filter body length). Stainless steel mesh gas filter element.
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Stainless Mesh In-Line Fuel Filter - 81-0241</h6>
								<h6><strong>12-Pack:</strong></h6>
								<h6>Stainless Mesh In-Line Fuel Filters - 81-0240</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/81-0261-ss2.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Cellulose Media Inline Fuel Filter</strong></h4></a>
								<h6>
								5/16" flanges 1-5/16" body diameter by 2-1/8" overall length (1-1/4" filter body length). Polymer treated paper gas filter element.
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Cellulose Media In-Line Fuel Filter - 81-0261</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/PF-1000.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Inline Fuel Filter - PF-1000</strong></h4></a>
								<h6>
								Filter Material: Cellulose Media Length: 4.281 in (109 mm) Outside Diameter: 2.125 in (54 mm)
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Cellulose Media In-Line Fuel Filter - PF-1000</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/PF-1100.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Inline Fuel Filter - PF-1100</strong></h4></a>
								<h6>
								Filter Material: Cellulose Media Length: 4.813 in (122 mm) Outside Diameter: 2.219 in (56 mm)
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Cellulose Media In-Line Fuel Filter - PF-1100</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/PF-1200.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Inline Fuel Filter - PF-1200</strong></h4></a>
								<h6>
								Filter Material: Cellulose Media Length: 2.875 in (73 mm) Outside Diameter: 2.438 in (62 mm)
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Cellulose Media In-Line Fuel Filter - PF-1200</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/PF-1300.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Inline Fuel Filter - PF-1300</strong></h4></a>
								<h6>
								Filter Material: Cellulose Media Length: 3.813 in (97 mm) Outside Diameter: 1.688 in (43 mm)
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Cellulose Media In-Line Fuel Filter - PF-1300</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/PF-2000.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Inline Fuel Filter - PF-2000</strong></h4></a>
								<h6>
								Filter Material: Cellulose Media Length: 7.813 in (198 mm) Outside Diameter: 2 in (51 mm)
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Cellulose Media In-Line Fuel Filter - PF-2000</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/PF-2100.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Inline Fuel Filter - PF-2100</strong></h4></a>
								<h6>
								Filter Material: Cellulose Media Length: 5.313 in (135 mm) Outside Diameter: 2.125 in (54 mm)
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Cellulose Media In-Line Fuel Filter - PF-2100</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/PF-2200.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Inline Fuel Filter - PF-2200</strong></h4></a>
								<h6>
								Filter Material: Cellulose Media Length: 5.625 in (143 mm) Outside Diameter: 3 in (76 mm)
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Cellulose Media In-Line Fuel Filter - PF-2200</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/PF-2300.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Inline Fuel Filter - PF-2300</strong></h4></a>
								<h6>
								Filter Material: Cellulose Media Length: 6.938 in (176 mm) Outside Diameter: 3 in (76 mm)
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Cellulose Media In-Line Fuel Filter - PF-2300</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/PF-2400.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Inline Fuel Filter - PF-2400</strong></h4></a>
								<h6>
								Filter Material: Cellulose Media Length: 6.563 in (167 mm) Outside Diameter: 2.125 in (54 mm)
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Cellulose Media In-Line Fuel Filter - PF-2400</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/PF-2500.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>K&N Inline Fuel Filter - PF-2500</strong></h4></a>
								<h6>
								Filter Material: Cellulose Media Length: 5.438 in (138 mm) Outside Diameter: 2.125 in (54 mm)</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Cellulose Media In-Line Fuel Filter - PF-2500</h6>
							</div>
						</div>
						<div class="j_wrapper">
						<hr>
							<div class="col-sm-3">
								<img src="image/81-0271.jpg">
							</div>
							<div class="col-sm-6">
								<a href="#"><h4><strong>Plastic "T" Fuel Line Fittings</strong></h4></a>
								<h6>
									High flow, durable, lightweight, easy to use. One size fits 1/4" to 3/8" I.D. hose.
								</h6>
							</div>
							<div class="col-sm-3">
								<h6><strong>Single:</strong></h6>
								<h6>Plastic "T" Fuel Line Fitting - 81-0271</h6>
								<h6><strong>12-Pack::</strong></h6>
								<h6>Plastic "T" Fuel Line Fittings - 81-0270</h6>
							</div>
						</div>
						<hr>
						<div class="col-sm-8">
							<h4><strong>K&N Inline Fuel/Oil Filters</strong></h4>
							<h6>K&N dual purpose inline fuel/oil filters are perfect for automotive racing applications. These inline filters can be used with a variety of oils and fuels including methanol. The filter material is made from stainless steel and the housing is made from anodized aluminum.</h6>
						</div>
						<div class="col-sm-4">
							<img src="image/inline-fuel-oil-filters_263x70.jpg">
						</div>
						</div>
					  </div>
					</div>
