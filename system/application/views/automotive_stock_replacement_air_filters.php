									...
									<div class="clearfix t_sm_align_l f_left f_sm_none relative s_form_wrap m_sm_bottom_15 p_xs_hr_0 m_xs_bottom_5">
										...
										<nav role="navigation" class="f_left f_xs_none d_xs_none m_right_35 m_md_right_30 m_sm_right_0">	
											<ul class="horizontal_list main_menu type_2 clearfix">
												<li class="current relative f_xs_none m_xs_bottom_5 m_left_10 m_xs_left_0"><a href="index_layout_wide.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Home</b></a>
													<!--sub menu-->
												...
												<li class="relative f_xs_none m_xs_bottom_5 m_left_10 m_xs_left_0"><a href="index_layout_wide.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Air Filters</b></a>
													<!--sub menu-->
													<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
														<ul class="sub_menu">
															<li><a class="color_dark tr_delay_hover" href="index_layout_wide.html">AUTOMOTIVE AIRFILTERS</a></li>
															<li><a class="color_dark tr_delay_hover" href="index.html">MOTOCYCLE /ATV AIR FILTERS</a></li>
															<li><a class="color_dark tr_delay_hover" href="index_layout_2.html">UNIVERSAL AD CLAMP-ON AIR FILTERS</a></li>
															<li><a class="color_dark tr_delay_hover" href="index_layout_wide.html">CABIN AIR FILTERS</a></li>
										...
										<li class="m_left_5 relative container3d" id="shopping_button">
											...
											<div class="shopping_cart top_arrow tr_all_hover r_corners">
												...
												<div class="sc_footer t_align_c">
													<a href="cart.html" role="button" class="button_type_4 d_inline_middle bg_light_color_2 r_corners color_dark t_align_c tr_all_hover m_mxs_bottom_5">View Cart</a>
													<a href="checkout.html" role="button" class="button_type_4 bg_scheme_color d_inline_middle r_corners tr_all_hover color_light">Checkout</a>
												</div>
											</div>
										</li>
									</ul>
			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
					  <div class="j_wrapper">	
						<div class="col-sm-6">
							<h4><strong>K&amp;N Replacement Air Filters</strong></h4>
							<br>
							<h6>
								<ul>
									<li style="font-size:16px;">Designed to Increase Horsepower</li>
									<li style="font-size:16px;">Easy to Install Drop-in Design</li>
									<li style="font-size:16px;">Lifetime Reusable Air Filter</li>
									<li style="font-size:16px;">Million Mile Limited Warranty<sup>®</sup></li>
									<li style="font-size:16px;">Lasts up to 50,000 Miles Between Servicing</li>
								</ul>
							</h6>
							<br>
							<h5><strong>Order your K&amp;N replacement air filter Factory Direct today!</strong></h5>
							<ul>
								<li>Fast and <strong>FREE SHIPPING</strong> with Minimum Order</li>
							    <li>Simple, Quick and Secure Online Ordering</li>
							</ul>
						</div>
						<div class="col-sm-6">
							<img src="image/air-filter-quality.jpg">
						</div>
						<div class="col-sm-12 j_wrapper grey j_border">
							<div class="col-sm-4">
								<img src="image/air-filter-why-kn2.jpg">
								<h6 class="text-center">Adding vehicle performance and excellent engine protection is easy with K&N automobile air filters</h6>
							</div>
							<div class="col-sm-8">
								<h4><strong>Why Get a K&N Air Filter?</strong></h4>
								<h6>A K&N replacement air filter is designed to improve vehicle performance, provide excellent engine protection and last the life of your car, truck, motorcycle, ATV and more. K&N air filters are easy to install and come with the worry-free K&N Million Mile Limited Warranty®.
								</h6>
							</div>
						</div>
						<div class="col-sm-12 j_wrapper j_border">
							<div class="col-sm-8">
								<h4><strong>K&N Air Filters are Designed to Increase Horsepower</strong></h4>
							...
							<div class="col-sm-4">
								<img src="image/air-filter-horsepower2.jpg">
								<h6 class="text-center">K&N air filters are designed to increase horsepower and acceleration.</h6>
							</div>
						</div>
						<div class="col-sm-12 j_wrapper grey j_border">
							<div class="col-sm-4">
								<img src="image/air-filter-install.jpg">
								<h6 class="text-center">K&N air filters are easy to install because of their simple drop-in design.</h6>
							</div>
							<div class="col-sm-8">
								<h4><strong>K&N Air Filters are Easy to Install</strong></h4>
								<h6>K&N replacement air filters are made for virtually every vehicle on and off the road and they are custom designed to fit into your specific vehicle’s factory air box. Instead of swapping out your old paper air filters over-and-over again, with K&N you simply drop in a K&N replacement air filter once and you’ve boosted the lifetime performance of your vehicle in as little as 5 minutes!</h6>
							</div>
						</div>
							<div class="col-sm-12 j_wrapper j_border">
							<div class="col-sm-8">
								<h4><strong>Lifetime Reusable Air Filters</strong></h4>
								<h6>K&N replacement air filters last up to 50,000 miles between servicing, depending on driving conditions. With the K&N Air Filter Cleaning Kit you can easily clean and re-oil your air filter bringing it back to brand-new condition and ready for another 50,000 miles of use. Your one K&N air filter is designed to last for the lifetime of your vehicle which can save you a bundle of money in the long-run and eliminate the waste generated from buying and disposing countless paper air filters.
								</h6>
							</div>
							<div class="col-sm-4">
								<img src="image/lifetime-air-filter.jpg">
								<h6 class="text-center">K&N air filters are reusable and designed to be the last air filter your vehicle will ever need.</h6>
							</div>
						</div>
						<div class="col-sm-12 j_wrapper grey j_border">
							<div class="col-sm-4">
								<img src="image/air-filter-warranty2.jpg">
								<h6 class="text-center">K&N replacement air filters come with a 1,000,000 mile limited warranty.</h6>
							</div>
							<div class="col-sm-8">
								<h4><strong>K&N Million Mile Limited Warranty®</strong></h4>
								<h6>K&N air filters are guaranteed to perform for up to10 years or 1,000,000 miles without needing replacement. For full details visit the K&N Million Mile Limited Warranty page for more details.</h6>
							</div>
						</div>
						<div class="col-sm-12 j_wrapper j_border">
							<div class="col-sm-12">
								<h4><strong>Air Filter Filtration & Engine Protection</strong></h4>
								<h6>K&N air filters offer an optimal blend of high air flow, filtration efficiency, durability and dust capacity. K&N high flow filter media has been tested in our own in-house laboratories and by independent labs using the ISO5011 air filtration standard developed by the Society of Automotive Engineers. Our goal at K&N is to design air filters with the most possible airflow while providing guaranteed engine protection</h6>
							</div>
							<div class="col-sm-8">
								<h4><strong>K&N Air Filter Testing</strong></h4>
								<h6>K&N is dedicated to providing quality air filter products that meet or exceed your high performance and high filtration demands. K&N uses independent testing labs in addition to conducting tests using our own state-of-the-art in-house testing laboratory. The quality of K&N air filters can also be seen outside the laboratory. Carl Judice, of New Iberia, Louisiana, drove more than one million miles with a single K&N air filter installed in his three-quarter ton Chevy pickup. Carl points out that he has never had to rebuild the engine or remove the cylinder head from his trusty pickup truck. Customer satisfaction along with real-world testing doesn't get any better than that.
								</h6>
							</div>
							<div class="col-sm-4">
								<img src="image/carls-air-filter.jpg">
								<h6 class="text-center">Carl Judice drove more than one million miles with a single K&N air filter installed in his Chevy truck.</h6>
							</div>
					  </div>
					  <div class="col-sm-12 j_wrapper j_border">
					  	<h4><strong>Air Filter Fuel Economy</strong></h4>
					  	<h6>
					  		Fuel economy testing and mileage claims are not as cut and dry as they may seem. The EPA's website states, "EPA's fuel economy estimates are designed to allow consumers to comparison shop. Your fuel economy will almost certainly vary from the EPA's fuel economy rating. This is based on a number of factors, such as weather, road conditions, your driving and maintenance habits, and your use of air conditioning." Many exaggerated claims are found in the marketplace by automotive product manufacturers claiming to improve vehicle gas mileage. K&N does not make any general fuel economy claims. We simply encourage you to try our washable air filter products for yourself.
					  	</h6>
					  	<br>
					  	<h4><strong>K&N Air Filter Oil</strong></h4>
					  	<h6>
					  ...
					  <div class="col-sm-12 j_wrapper j_border">
					  	<h4><strong>K&N Consumer Protection</strong></h4>
					  	<h6>
					  	...
					  	<br>
					  	<h4><strong>Consumer Protection Pledge</strong></h4>
					  	<h6>
					  ...
					  <div class="col-sm-12 j_wrapper j_border">
					  	<h4><strong>K&N Air Filter History</strong></h4>
					  	<h6>
					  		K&N Filters has been designing and manufacturing performance air filters since 1969. We have designed and manufactured over 2400 high flow air filters to fit most of the latest passenger vehicles and over 500 performance air intakes for automotive and motorcycle owners interested in increasing vehicle horsepower and acceleration. K&N also makes thousands of racing and specialty type air filters and we are the #1 Filter in NASCAR®.
					  	</h6>
					  	<br>
					  	<h4><strong>Other K&N Performance Air Filter Products</strong></h4>
					  	<h6>
					  	K&N replacement air filters for motorcycle & ATV offer a lifetime of performance for Harley-Davidson® motorcycles, sports bikes, off-road vehicles, watercraft, snowmobiles and go karts. K&N heavy duty diesel air filters offer excellent filtration and engine protection for class 4-8 trucks, diesel equipment, motorhomes, recreational vehicles, buses, fire trucks, transport vehicles, refrigeration equipment, generators and big rigs. K&N small engine & light industrial air filters are designed to improve the performance of tractors, outdoor power equipment and other small engine applications. K&N also offers a variety of racing air filters, boat, watercraft and other marine flame arrestors, universal clamp on air filters and crank case vent filters for performance and engine protection. Many universal air filter sizes and shapes are available to fit your needs. A K&N car air filter replaces the stock paper filter and provides performance and engine protection.
					  	</h6>
					  </div>
					  <div class="col-sm-12 j_wrapper">
					  	<div class="container-fluid grey">
					  		<h4><strong><br>Latest Customer Reviews</strong></h4>
					  		<div class="col-sm-12 j_border">
					  			<div class="col-sm-2">
					  				<img src="image/33-2129.jpg">
					  			</div>
					  			<div class="col-sm-10">
					  				<h4><strong>K&N Replacement Air Filter Review - 33-2129</strong></h4>
					  				<h6>
					  					<blockquote>"I could tell an immediate difference after replacing the stock air filter in my 2011 GMC Sierra with the K&N filter. Engine performance increased dramatically. I am very pleased." </blockquote> James Davis Clayton, North Carolina
					  				</h6>
					  			</div>
					  		</div>
					  		<div class="col-sm-12 j_border">
					  			<div class="col-sm-2">
					  				<img src="image/33-2135.jpg">
					  			</div>
					  			<div class="col-sm-10">
					  				<h4><strong>K&N Replacement Air Filter Review - 33-2135</strong></h4>
					  				<h6><blockquote>"Ordering on-line was easy and product arrived earlier than expected. Thank You"</blockquote>Jan Pedersen Minnesota</h6>
					  			</div>
					  		</div>
					  		<div class="col-sm-12 j_border">
					  			<div class="col-sm-2">
					  				<img src="image/33-2281.jpg">
					  			</div>
					  			<div class="col-sm-10">
					  				<h4><strong>K&N Replacement Air Filter Review - 33-2281</strong></h4>
					  				<h6><blockquote>"I've bought several K & N filters, for my Toyota's, and they are a perfect fit, easy to install and gas mileage is up just a bit. The new stickers wirh warnings for service shops that are not familiar wirh K & N was appreciated."</blockquote>Oly Toledo, Oregon</h6>
					  			</div>
					  		</div>
					  		<div class="col-sm-12 j_border">
					  			<div class="col-sm-2">
					  				<img src="image/33-2865.jpg">
					  			</div>
					  			<div class="col-sm-10">
					  				<h4><strong>K&N Replacement Air Filter Review - 33-2865</strong></h4>
					  				<h6><blockquote>"FIVE STARS K&N makes exceptional filters that fit perfectly and provide the best over the counter performance for minimal investment. My mileage remains at 48-50MPG on my TDI with improved acceleration using the K&N filter. Highly recommended. Since you have to replace your filter anyway, why not go with the best Bonus that its washable and will not need replacing for probably the life of the vehicle. Don't waste your money on other cheaper filters, K&N is worth the investment."
					  				</blockquote>Jetta TDI Owner Janesville, Wisconsin</h6>
					  			</div>
					  		</div>
					  		<div class="col-sm-12 j_border">
					  			<div class="col-sm-2">
					  				<img src="image/33-2304.jpg">
					  			</div>
					  			<div class="col-sm-10">
					  				<h4><strong>K&N Replacement Air Filter Review - 33-2304</strong></h4>
					  				<h6><blockquote>"I've only had the K&N filter in my Subaru Outback for a few weeks, but I noticed an immediate increase in power. The exhaust even sounds a little throatier. Website was a breeze and delivery was very quick. Thanks."</blockquote>Randy Riddle North Carolina</h6>
					  			</div>
					  		</div>
					  		<div class="col-sm-12 j_border">
					  			<div class="col-sm-2">
					  				<img src="image/33-2364.jpg">
					  			</div>
					  			<div class="col-sm-10">
					  				<h4><strong>K&N Replacement Air Filter Review - 33-2364</strong></h4>
					  				<h6><blockquote>"Had one of these air filters on my 1998 Dodge 4WD Turbo Diesel and had 340,000 miles on the air filter. Gave my truck to my daughter because it stills runs great and should get another 150,000 miles before any engine work needs to be done."</blockquote>David Lopez Pagosa Springs, Colorado</h6>
					  			</div>
					  		</div>
					  		<div class="col-sm-12 j_border">
					  			<div class="col-sm-2">
					  				<img src="image/33-2480.jpg">
					  			</div>
					  			<div class="col-sm-10">
					  				<h4><strong>K&N Replacement Air Filter Review - 33-2480</strong></h4>
					  				<h6><blockquote>"I live in the UAE, and ordered this fillter for my Mazda 3 2014 2.0L Skyactive.The K&N filtter perfectly fits.I placed the order on 25/11 and recived on 28/11; what amazing delivery service through FEDEX. Thanks alot pro; good business idea. Ssimply get rid off genuine rubish mazda engine filter"</blockquote>Jamal Badhafari Abu Dhabi, UAE</h6>
					  			</div>
					  		</div>
					  	</div>
					  </div>
