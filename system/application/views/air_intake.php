			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
					  <div class="j_wrapper">	
						<div class="col-sm-6">
						<h4><strong>K&N Air Intakes / Cold Air Intakes</strong></h4>
						<h6>
							<ul>
							    <li>Adds Horsepower</li>
						...
						<br>
						<h6>
							K&N air intake products add horsepower, torque and acceleration to your vehicle. If you are looking to improve performance, K&N air intakes and cold air induction systems are easy to install and come with a million mile limited warranty. <strong>K&N air intake systems are available for cars, trucks, motorcycles, ATV's and RV's.</strong>
						</h6>
						</div>
						<div class="col-sm-6">
							<img src="image/air_intake_hl_main.jpg">
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/air_intake_cat1.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Automotive Air Intakes</strong></h4></a>
								<h6>
						...
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/air_intake_cat2.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Motorcycle and ATV Air Intakes</strong></h4></a>
								<h6>
									K&N air intakes for motorcycles add power and torque while adding a great custom look. K&N air intakes for ATV's reduce air restriction for power when you need it.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/air_intake_cat3.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Diesel Truck Air Intakes</strong></h4></a>
								<h6>
									K&N diesel application high-flow air intake systems incorporate rotationally molded high density polyethylene tubes. This material allows our intake designs to have the most flexibility for getting great diesel truck horsepower numbers.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/air_intake_cat4.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>RV Air Intakes</strong></h4></a>
								<h6>
									K&N air intakes for RV's and motor homes give a needed boost to the heavy vehicles. RV's can definitely utilize the extra power a K&N air intake provides getting up to speed and passing, especially on inclines.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/air_intake_cat5.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Air Intake Installation Videos</strong></h4></a>
								<h6>
									Want to see how easy it is to install a K&N air intake? Take a look at the library of air intake installation videos to see how simple it is to add power and performance to your vehicle.
								</h6>
							</div>
							<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/air-intakeMM.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Air Intakes by Vehicle Manufacturer</strong></h4></a>
								<h6>
									K&N cold air intake systems are available for many cars, trucks, motorcycles, ATV's and RV's. Select the manufacturer of your vehicle here and browse to the air intake system that fits your vehicle.
								</h6>
							</div>
							<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/install.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Air Intake Installation Instructions</strong></h4></a>
								<h6>
									K&N air intake installation instruction sheets make it easy to install a K&N air intake? Select an air intake part number from the list on this page for installation instructions in pdf format. Installation typically takes 90 minutes or less and only requires common hand tools.
								</h6>
							</div>
						</div>
						</div>
