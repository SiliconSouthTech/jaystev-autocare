...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	...
	<body>
		...
		<div class="wide_layout relative w_xs_auto">
			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30 j_wrapper">
						<div class="col-sm-6">
						<h4>K&N Replacement ATV and Motorcycle Oil Filters</h4>
						<ul>
							<li>Uniform pleated Synthetic filter media provides high capacity and outstanding filtration</li>
							<li>Premium Synthetic Media allows for high-flow rates associated with Synthetic and Synthetic blended oils</li>
							<li>Protected by a heavy-duty canister and base plate, with a double-rolled seal </li>
							<li>Check-Valve/Anti-drain Back Valve prevents drain-back and dry starts(where applicable) </li>
							<li>Pre-Lubed base gasket provides excellent seal</li>
							<li>17mm Hex Nut Allows Easy-On, Easy Wrench-Off<sup>®</sup></li>
							<li>Pre-drilled for Safety Wire security </li>
							<li>K&amp;N Limited Warranty<sup>®</sup></li>
						</ul>
						</div>
						<div class="col-sm-6">
							<img src="image/oil-filter-group2.jpg" class="j_border">
						</div>
						<div class="col-sm-12 j_wrapper">
						<h4>K&N ATV & Motorcycle Oil Filters</h4>
						<h6>K&N motorcyle and ATV oil filters provide outstanding filtration levels and a high oil flow rate. They are able to handle heavy duty applications and block 99% of foreign material. They are great all types of oils and will add increased performance to your motorcycle or ATV. K&N offers premium Wrench-Off, Pro-Series, Cartridge and Billet Oil Filters for a range of motorcycle and ATV applications. K&N delivers a premium ATV and motorcycle oil filter which is built to withstand the high demands of racing conditions. A large filter media provides high-flow rates and outstanding oil filtration to keep your motor running clean and smooth. K&N oil filters deliver performance and confidence!
						</h6>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-2">
								<img src="image/KN-128.jpg">
							</div>
							<div class="col-sm-10">
								<h4>K&N Canister Type ATV & Motorcycle Oil Filters</h4>
								<h6>K&N Wrench-Off canister oil filters for the motorcycle and ATV are a great choice for race applications. A K&N ATV and motorcycle oil filter offers high oil flow rates and provides the duability and strength needed to perform in extreme conditions. Most K&N canister type ATV and motorcycle oil filters come with a 17mm nut for easy removal.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-2">
								<img src="image/KN-140.jpg">
							</div>
							<div class="col-sm-10">
								<h4>K&N Cartridge Motorcycle & ATV Oil Filters</h4>
								<h6>K&N high flow cartridge oil filters provide great filtration and are ideal for high end synthetic motor oils. K & N oil filters are designed for cars, trucks, SUV's and more.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-2">
								<img src="image/SS-1002.jpg">
							</div>
							<div class="col-sm-10">
								<h4>K&N Washable and Reusable Billet Oil Filters for Motorcycles</h4>
								<h6>K&N has released a reusable billet oil filters for the motorcycle that will last the lifetime of your bike under normal operating conditions. Each billet motorcycle oil filter is manufactured from high quality material and components, designed for very high flow rates at low restriction, providing excellent engine protection and is easy to clean and maintain.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-2">
								<img src="image/harley-oil-filters.jpg">
							</div>
							<div class="col-sm-10">
								<h4>K&N Oil Filters for Harley Davidson® Motorcycles</h4>
								<h6>K&N Harley® motorcycle oil filters provide outstanding filtration levels and allow for high oil flow rates. These K&N Harley Davidson® oil filters are great to use with all types of oils and will add increased performance to your motorcycle. K&N offers premium Wrench-Off style motorcycle oil filters and washable/reusable billet oil filters for a range of Harley Davidson® motorcyles.
								</h6>
							</div>
						</div>
					</div>
