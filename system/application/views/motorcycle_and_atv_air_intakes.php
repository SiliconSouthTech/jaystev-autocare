			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
						<br>
						<h4>K&N Performance Air Intake Systems for Motorcycles and ATV's</h4>
						<br>
						<div class="col-sm-12">
						<h6>
							K&N offers a selection of custom air intake systems for V-Twin Motorcycles, Sport ATVs and Side-by-Side UTVs.  Designed and dynoed in-house in our own R&D facility in Riverside, CA, these performance air intake systems provide a Guaranteed increase in Horsepower that you can feel
						</h6>	
						</div>
						<div class="col-sm-12">
							<div class="j_wrapper">
								<div class="col-sm-4">
								<img src="image/harley-airchargers-together2.jpg" class="j_image_placeholder3">
								</div>
								<div class="col-sm-8">
								<h4>AirCharger® Performance Intake Systems for Harley-Davidson® Motorcycles</h4>
								<h6>K&N's AirCharger Intake Systems provide an aggressive appearance while delivering a Guaranteed increase in Horsepower! Replace your stock air cleaner with a K&N AirCharger intake system. This complete intake system is packed with an oversized K&N high flow air filter, a mandrel bent high-flow aluminum intake tube and a complete breather system delivering serious performance.
								</h6>
								</div>
							</div>
							<div class="j_wrapper">
								<div class="col-sm-4">
								<img src="image/RK-3932.jpg" class="j_image_placeholder3">
								</div>
								<div class="col-sm-8">
								<h4>Street Metal™ Intake Systems for Harley-Davidson® Motorcycles</h4>
								<h6>K&N's Street Metal intake systems provide custom good looks and a Guaranteed increase in Horsepower for your Harley Davidson® motorcycle. Boost performance with a K&N Street Metal air intake system available in a variety of designs. These complete air intake systems replace the stock intake assembly with a custom built aluminum backing plate, an oversized original K&N high flow air filter and a custom designed cover with a bright mirror finish.
								</h6>
								</div>
							</div>
							<div class="j_wrapper">
								<div class="col-sm-4">
								<img src="image/RK-39152.jpg" class="j_image_placeholder3">
								</div>
								<div class="col-sm-8">
								<h4>RK Series Intake Systems for Harley-Davidson® Motorcycles</h4>
								<h6>K&N's Custom RK series air intake systems offer good looks and are designed to provide increased horsepower on your metric cruiser. The complete intake system provides excellent airflow and smooth delivery to the engine, while delivering performance and filtration over the life of the motorcycle. Machined from billet aluminum, these air cleaners are polished then chrome plated to compliment any show bike.
								</h6>
								</div>
							</div>
							<div class="j_wrapper">
								<div class="col-sm-4">
								<img src="image/63-1129.jpg" class="j_image_placeholder3">
								</div>
								<div class="col-sm-8">
								<h4>AirCharger® Intake Systems for Side by Side UTV's</h4>
								<h6>K&N's AirCharger® air intake systems will provide a guaranteed increase in horsepower to your side by side UTV. Developed in-house, the K&N AirCharger completely replaces the stock airbox. Mounting directly to the throttle-body, a mandrel-bent high flow intake tube is routed into an oversized powder coated aluminum heat shield, providing for protection from the elements. Oversized K&N high flow air filter specifically developed for off-road provides high capacity and increased protection in extreme conditions.
								</h6>
								</div>
							</div>
							<div class="j_wrapper">
								<div class="col-sm-4">
								<img src="image/63-1123_2.jpg" class="j_image_placeholder3">
								</div>
								<div class="col-sm-8">
								<h4>AirCharger® Air Intake Systems for Sport ATV's</h4>
								<h6>K&N's AirCharger® air intake systems are developed for racing and will provide a guaranteed increase in horsepower to your sport ATV. Using K&N's high flow technology, a roto molded high flow intake tube is developed and routed into a powder coated aluminum heat shield, providing protection from the elements. Oversized K&N high flow air filter specifically developed for off-road provides high-capacity and increased protection in extreme conditions.
								</h6>
								</div>
							</div>
						</div>
