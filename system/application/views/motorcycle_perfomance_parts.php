				...
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
					  <div class="j_wrapper">	
						...
						<div class="col-sm-6">
							<img src="image/ps_pp.jpg">
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/ps_wrap.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Air Filter Wraps</strong></h4></a>
								<h6>
						...
						<div class="j_wrapper">
							...
							<div class="col-sm-9">
								<a href="#"><h4><strong>Vent Air Filters</strong></h4></a>
								<h6>
									K&N vent filters were designed for racing needs and to look great in show vehicles. They come in several styles with rubber or chrome tops, with or without shields and in a variety of mounting types for just about any vent or valve cover need.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/ps_vs.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Velocity Stack Air Filter Adapter</strong></h4></a>
								<h6>
									K&N's Velocity Stack Air Filter Adapter fits 41MM Keihin CR Flat Slide Carburetors.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							...
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Air/Fuel Ratio Monitors</strong></h4></a>
								<h6>
						...
						<div class="j_wrapper">
							...
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Air Filter Accessories</strong></h4></a>
								<h6>
									K&N offers an assortment of carburetor adapter flanges, hose connectors, washers and other air filter accessories.
								</h6>
							</div>	
						</div>
						</div>
