			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
						<br>
						<h4 class="text-center">Air Intakes by Vehicle Manufacturer</h4>
						<div class="col-sm-7">
						<h6>
							K&N has been improving engine power and torque for over 20 years with easy to install performance air intakes. K&N air intakes are specifically engineered to use existing factory holes and mounting points, making installation simple. The vast majority of our performance parts do NOT require any cutting or drilling so adding power and torque is simple. K&N air intake systems are capable of going up to 100,000 miles before cleaning is needed depending on driving conditions. K&N performance air intakes are guaranteed to improve engine performance and horsepower and these parts are backed with a 1,000,000 mile lifetime limited warranty.
						</h6>	
						</div>
						<div class="col-sm-5">
							<img src="image/air_intake_hl_main.jpg" class="j_image_placeholder1">
						</div>
						<div class="col-sm-12">
						<h4>
							Select a vehicle make below to find your performance air intake.
						</h4>
						<h6>
							K&N is a worldwide leader in performance parts that add power and torque to a vehicle. Choose a link below to find a simple to install air intake for your car, truck, motorcycle or ATV.
						</h6>
						</div>
						<div class="j_table_format_pane">
								<!-- A -->
							<div class="j_table_format_pane col-sm-12">
								<h3><strong>A</strong></h3>
							</div>
							<div class="j_table_format col-sm-12">
								<br> Acura <br>	
								Audi <br>
								Alfa Romeo
							</div>
