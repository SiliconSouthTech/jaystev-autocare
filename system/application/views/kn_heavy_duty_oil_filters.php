			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
						<br>
						<h4 class="text-center">K&N Heavy Duty Wrench-Off® Oil Filters</h4>
						<div class="col-sm-8">
						<h6>
							<ul>
								<li>High performance design</li>
							    <li>Outstanding filtration</li>
								<li>Provides for high oil flow rates</li>
								<li>Attached nut for easy removal</li>
								<li>Ideal for high compression turbo diesel engines</li>
							</ul>
						</h6>	
						</div>
						<div class="col-sm-4">
							<img src="image/hd-wrench-off-filters.jpg" class="j_image_placeholder1">
						</div>
						<div class="col-sm-6">
						<h4><strong>Heavy-Duty Construction for Extreme Conditions</strong></h4>
						<h6>
							K&N Wrench-Off® Diesel Oil Filters have been specially designed for the high compression levels and tighter tolerances of turbo diesel engines. Our synthetic microglass media provides lower restriction and incredible engine protection. Add to this our thicker canister and higher burst strength and you have one serious heavy duty oil filter.
						</h6>
						</div>
						<div class="col-sm-12">
						<h4><strong>K&N Heavy Duty Oil Filters Have Nuts</strong></h4>
						<h6>
							We've all been there: whether it's remembering where that disappearing canister tool is; having oil leak all over your garage and yourself; or finally giving up and pounding a screwdriver through the filter just to get it off. Our Wrench-Off® Diesel Oil Filters come with a nut welded to the top of the canister so they can be easily wrenched-off with a standard tool.
						</h6>
						</div>
						<hr> <br>
						<div class="j_wrapper container">
							<img src="image/explode5.jpg">						
						</div>
					</div>
				</div>
			</div>
