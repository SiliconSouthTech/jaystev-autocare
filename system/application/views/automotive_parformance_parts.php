			...
			<div class="container">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
					  <div class="j_wrapper">	
						<div class="col-sm-6">
						<h4><strong>K&N Automotive Performance Parts</strong></h4>
						</div>
						<div class="col-sm-6">
							<img src="image/perf_parts2.jpg">
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/PrechrgrGroup.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Air Filter Wraps - PreChargers, DryChargers and AirForce Wraps</strong></h4></a>
								<h6>
									K&N PreCharger, DryCharger and AirForce Filter Wraps are designed to extend the service interval of your K&N Air Filter when used in extreme driving conditions.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
						...
						<div class="j_wrapper">
							...
							<div class="col-sm-9">
								<a href="#"><h4><strong>Crankcase Vent Air Filters</strong></h4></a>
								<h6>
									K&N crankcase vent filters were designed for racing needs and to look great in show cars. They come in several styles with rubber or chrome tops, with or without shields and in a variety of mounting types for just about any valve cover need.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/85-8927s.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Plenums & Weber Carburetor Adapter</strong></h4></a>
								<h6>
									K&N Plenums can be used with hose to feed cooler outside air into the engine. K&N carburetor adapters for Weber carburetors allow many more air filter assembly options.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/stubstack.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Stubstacks</strong></h4></a>
								<h6>
									K&N Stubstacks are designed to increase the airflow of carburetors by decreasing restriction around the choke horn.
								</h6>
							</div>
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/carbon_fiber.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Carbon Fiber Composites</strong></h4></a>
								<h6>
									K&N's Carbon fiber composites have attractive cosmetic appeal and the outstanding stiffness to weight ratio that is needed to stay competitive in today's racing industry. K&N manufactures carbon fiber air filter assembly lids, carbon fiber air filter tops, carbon fiber hood scoops for racing and lightweight carbon fiber universal air box assemblies which are a must have for racers using traditional multi-siamese stacks.
								</h6>
							</div>	
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/85_1150.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Air Filter Accessories</strong></h4></a>
								<h6>
									K&N offers an assortment of carburetor adapter flanges, hose connectors, washers, mass air sensor weld-on adapters and other air filter accessories.
								</h6>
							</div>	
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/filtermindersm.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Filter Minder Air Restriction Gauge</strong></h4></a>
								<h6>
									The Filter Minder is an air filter service indicator that monitors air filter restriction and indicates when the air filter should be serviced.
								</h6>
							</div>	
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/airfuelmons.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>Air/Fuel Ratio Monitors</strong></h4></a>
								<h6>
									K&N Air / Fuel Monitors help performance enthusiasts calibrate an optimum air/fuel mixture ratio for power, economy and/or improved drivability. They will work on carbureted, fuel injected, supercharged or turbocharged engines using unleaded gasoline, alcohol, propane or nitrous oxide.
								</h6>
							</div>	
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/inline-filters_128x100.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Inline Fuel/Oil Filters</strong></h4></a>
								<h6>
									K&N inline fuel/oil filters are perfect for racing applications and can be used with a variety of oils and fuels including methanol.
								</h6>
							</div>	
						</div>
						<div class="j_wrapper">
							...
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Inline Fuel Filters</strong></h4></a>
								<h6>
									K&N in-line fuel filters are ideal for the dirty gas we get now days. K&N high volume, low pressure in-line fuel filter products are easy to clean by simply backflushing.
								</h6>
							</div>	
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/81-0401.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Inline Fuel Pumps</strong></h4></a>
								<h6>
									A K&N Inline Fuel Pump offers premium fuel system hardware with a universal design that fits a wide variety of applications. K&N Inline Fuel Pumps are compatible with most fuels and helps prevent vapor lock and flooding.
								</h6>
							</div>	
						</div>
						<div class="j_wrapper">
							<div class="col-sm-3">
								<img src="image/PF-4200_Base.jpg">
							</div>
							<div class="col-sm-9">
								<a href="#"><h4><strong>K&N Diesel Fuel Filters</strong></h4></a>
								<h6>
									K&N Diesel Fuel Filters are designed for high flow rates with great filtration. They are constructed from material that is strong and traps unwanted foreign contaminents.
								</h6>
							</div>	
						</div>
						</div>
